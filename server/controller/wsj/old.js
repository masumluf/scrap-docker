...
async function wsjOld(req, res) {
  ...
  await page.goto(`https://www.wsj.com/news/types/${topicName}`, {
        ...
        return [...document.querySelectorAll("#latest-stories article")].map(
          (element) => {
            return {
              ...
              published_at: element.querySelector("div:nth-child(2) > div:nth-child(3) div")?.innerText,
