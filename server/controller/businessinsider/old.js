...
async function businessinsiderOld(req, res) {
  let count = 0;
  ...
  await page.goto(`https://www.businessinsider.com/${topicName}`, {
            ...
            return {
              ...
              topic: [
                ...document.querySelectorAll(
                  ".post-breadcrumbs.headline-bold a"
                ),
              ][1].innerText,
            };
          } catch (error) {
      ...
      let results = await page.evaluate(() => {
        return [
          ...
          const article = {
            ...
            published_at:
              element.querySelector(".js-date-format")?.innerText ?? "today",
            images_url:
              Object?.keys(
                JSON?.parse(
