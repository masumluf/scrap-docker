...
async function evisaimmigrationOld(req, res) {
  ...
  await page.goto(`https://www.evisaimmigration.com/en/blog/${topicName}`, {
  ...
  async function collectData() {
    try {
      ...
      let results = await page.evaluate(() => {
        return [...document.querySelectorAll(".row:nth-child(2) > div")].map(
          (element) => ({
